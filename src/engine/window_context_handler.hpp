...
public:
    WindowContextHandler(const std::string& window_name,
                         sf::VideoMode window_mode = sf::VideoMode::getFullscreenModes()[0],
                         int32_t window_style = sf::Style::Default)
        : m_window(window_mode, window_name, window_style)
    ...
    WindowContextHandler(const std::string& window_name, int32_t window_style)
        : WindowContextHandler(window_name, sf::VideoMode::getDesktopMode(), window_style)
    {}
